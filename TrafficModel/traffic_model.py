...
def initialize_tree():
    ...
    try:
        cur.execute("""SELECT location_road, location_bound, location_area, timestamp, traffic FROM entries WHERE update_timestamp > timestamp '2017-07-10 00:00:00'""")
    except:
...
def get_prediction(street, segment, date, time):
    ...
    prediction_string = prediction[start_pt + 1: end_pt]
...
if str(arguments[1]) == 'init': # initializes tree (WARNING: OVERWRITES MODEL FILE)
    ...
    print("8:00 AM")
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 32], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 32], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 32], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 32], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 32], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 32], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 32], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 32], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 32], data)))

    print("12:00 PM")
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 48], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 48], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 48], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 48], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 48], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 48], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 48], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 48], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 48], data)))

    print("17:00 PM")
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 68], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 68], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 68], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 68], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 68], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 68], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 68], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 68], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 68], data)))

    print("19:00 PM")
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 76], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 76], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 76], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 76], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 76], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 76], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 76], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 76], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 76], data)))

    print("23:00 PM")
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 92], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 92], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 92], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 92], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 92], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 92], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 92], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 92], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 92], data)))
