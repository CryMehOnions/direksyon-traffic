...
if str(arguments[1]) == 'init': # initializes tree (WARNING: OVERWRITES MODEL FILE)
    ...
    data = pickle.load(open("model.p", "rb"))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 60], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 60], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 60], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 60], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 60], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 60], data)))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 60], data)))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 60], data)))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 60], data)))
