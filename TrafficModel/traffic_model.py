...
if str(arguments[1]) == 'init': # initializes tree (WARNING: OVERWRITES MODEL FILE)
    ...
    data = pickle.load(open("model.p", "rb"))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sun', 20]), data))
    print(str(classify(['EDSA', 'Mall of Asia', 'Mon', 20]), data))
    print(str(classify(['EDSA', 'Mall of Asia', 'Tue', 20]), data))
    print(str(classify(['EDSA', 'Mall of Asia', 'Wed', 20]), data))
    print(str(classify(['EDSA', 'Mall of Asia', 'Thu', 20]), data))
    print(str(classify(['EDSA', 'Mall of Asia', 'Fri', 20]), data))
    print(str(classify(['EDSA', 'Mall of Asia', 'Sat', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sun', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Mon', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Tue', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Wed', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Thu', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Fri', 20]), data))
    print(str(classify(['C5', 'Ateneo De Manila University', 'Sat', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sun', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Mon', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Tue', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Wed', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Thu', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Fri', 20]), data))
    print(str(classify(['Ortigas', 'La Salle Greenhills', 'Sat', 20]), data))
